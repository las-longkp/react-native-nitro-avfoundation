...
- [`android/`](android): All your `android`-specific implementations.
  - [`build.gradle`](android/build.gradle): The gradle build file. This contains four important pieces:
    ...
    3. Adds all Nitrogen files (`apply from: '.../NitroAvfoundation+autolinking.gradle'`)
  ...
  - [`CMakeLists.txt`](android/CMakeLists.txt): The CMake build file to build C++ code. This contains four important pieces:
    1. Creates a library called `NitroAvfoundation` (same as in `nitro.json`)
    2. Adds all Nitrogen files (`include(.../NitroAvfoundation+autolinking.cmake)`)
  ...
  - [`src/main/java/com/margelo/nitro/nitroavfoundation/`](android/src/main/java/com/margelo/nitro/nitroavfoundation/): All Kotlin implementations.
    - [`NitroAvfoundationPackage.kt`](android/src/main/java/com/margelo/nitro/nitroavfoundation/NitroAvfoundationPackage.kt): The react-native package. You need this because the react-native CLI only adds libraries if they have a `*Package.kt` file. In here, you can autolink all Kotlin HybridObjects.
...
- [`NitroAvfoundation.podspec`](NitroAvfoundation.podspec): The iOS podspec build file to build the iOS code. This contains three important pieces:
